    ...
    for H in cf.pnn.Hidden_variables:
        ...
        for v in cf.pnn.visibility:
            ...
            for trains in range(cf.pnn.nb_trains):
                print('GHZ_assemblage_1unt_2m: Starting for H = {}, v = {}, trains = {}'.format(H, v, trains + 1))
...
if __name__ == '__main__':
    ...
    np.save('./data/GHZ_assemblage_1unt_2m_v.npy', plot_v)
    np.save('./data/GHZ_assemblage_1unt_2m_loss.npy', plot_Loss)
    # savemat('./data/GHZ_assemblage_1unt_2m.mat', {'loss': plot_Loss, 'v': plot_v})
    ...
    plt.ylabel('Loss')
    plt.xlabel('v')
    plt.savefig("./figs/GHZ_assemblage_1unt_2m.png")
    plt.savefig("./figs/GHZ_assemblage_1unt_2m.pdf")
    plt.show()