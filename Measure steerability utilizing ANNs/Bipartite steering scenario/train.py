    ...
    for H in cf.pnn.Hidden_variables:
        ...
        for v in cf.pnn.visibility:
            ...
            for trains in range(cf.pnn.nb_trains):
                print('Isotropic_assemblage_2m: Starting for d={}, H = {}, v = {}, trains = {}'.format(cf.pnn.dim, H, v, trains + 1))
...
if __name__ == '__main__':
    ...
    np.save('./data/Isotropic_assemblage_2m_2d_v.npy', plot_v)
    np.save('./data/Isotropic_assemblage_2m_2d_loss.npy', plot_Loss)
    # savemat('./data/Isotropic_assemblage_2m_2d.mat', {'loss': plot_Loss, 'v': plot_v})
    ...
    plt.ylabel('Loss')
    plt.xlabel('v')
    plt.savefig("./figs/Isotropic_assemblage_2m_2d.png")
    plt.savefig("./figs/Isotropic_assemblage_2m_2d.pdf")
    plt.show()